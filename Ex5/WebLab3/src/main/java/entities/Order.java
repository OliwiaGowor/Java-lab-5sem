...
public class Order {
     ...
     */
    public Order(String number, Date purchaseDate, String buyer, String paymentMethod) {
        this.number = number;
    ...
    /**
     * Method adds list of products to odrder and calculates sumNetto, sumVat
     * and sumBrutto parameters.
     *
     * @param products parameter represents list of products to add and
     * calculate
     */
    public void addAndCalcProducts(List<Product> products) {
        this.products = products;
