 ...
 */
package pl.polsl.gowor.oliwia.console;
...
public class View {
    ...
    private void printProduct(Product product) {
        System.out.println(product.getProductName() + "|" + product.getQuantinity() + "|" + product.getUnit() + "|" + product.getPriceNetto() + "|"
                + product.getValueNetto() + "|" + product.getVatRate().getVatRate() + "|" + product.getValueVat() + "|" + product.getValueBrutto());
    }
    ...
    public void askForProductVatRate() {
        System.out.println("Select VAT rate:");
