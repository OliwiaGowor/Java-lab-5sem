...
public class Product {
    ...
    /**
     * Value represents productName of the product.
     */
     ...
     * Class contructor.
     *
     * @param name parameter represents productName of the product
    ...
    /**
     * Method returns productName class parameter.
     *
     * @return parameter representing productName of the product
     */
    ...
    /**
     * Method sets productName class parameter.
     *
     * @param productName parameter representing productName of the product
     */
