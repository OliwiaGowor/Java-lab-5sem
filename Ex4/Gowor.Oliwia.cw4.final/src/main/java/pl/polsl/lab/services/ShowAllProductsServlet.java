...
public class ShowAllProductsServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Double priceNetto = Double.parseDouble(request.getParameter("priceNetto"));

        products.add(new Product(productName, Double.parseDouble(request.getParameter("priceNetto")),
